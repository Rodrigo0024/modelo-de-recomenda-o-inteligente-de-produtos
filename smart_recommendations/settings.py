...
INSTALLED_APPS = [
    ...
    # Third-party - VERSÃO SIMPLIFICADA
    'django_bootstrap5',  # Bootstrap para Django
]
...
ROOT_URLCONF = 'smart_recommendations.urls'
...
WSGI_APPLICATION = 'smart_recommendations.wsgi.application'
